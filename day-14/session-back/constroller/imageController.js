...
const genrateImage = async (req, res) => {
  ...
  //     "accept-language": "en-IN,en-GB;q=0.9,en-US;q=0.8,en;q=0.7",
  //     "api-token":
  //       "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE3MTczMzY0MDAsImV4cCI6MTcxNzQyMjgwMH0.rgyEylqrIz3sg35bsNCfrZfNpQTvlVhh-cnUcsV4tSE",
  //     authorization: "hotpot-t2mJbCr8292aQzp8CnEPaK",
  //     "content-type":
  //       "multipart/form-data; boundary=----WebKitFormBoundaryhSt83rPyJQBmMb3B",
  //     "sec-ch-ua":
  //       '"Google Chrome";v="125", "Chromium";v="125", "Not.A/Brand";v="24"',
  //     "sec-ch-ua-mobile": "?0",
  //     "sec-ch-ua-platform": '"Windows"',
  ...
  //   referrer: "https://hotpot.ai/",
  //   referrerPolicy: "strict-origin-when-cross-origin",
  //   body: '------WebKitFormBoundaryhSt83rPyJQBmMb3B\r\nContent-Disposition: form-data; name="seedValue"\r\n\r\nnull\r\n------WebKitFormBoundaryhSt83rPyJQBmMb3B\r\nContent-Disposition: form-data; name="inputText"\r\n\r\ncar\r\n------WebKitFormBoundaryhSt83rPyJQBmMb3B\r\nContent-Disposition: form-data; name="width"\r\n\r\n512\r\n------WebKitFormBoundaryhSt83rPyJQBmMb3B\r\nContent-Disposition: form-data; name="height"\r\n\r\n512\r\n------WebKitFormBoundaryhSt83rPyJQBmMb3B\r\nContent-Disposition: form-data; name="styleId"\r\n\r\n49\r\n------WebKitFormBoundaryhSt83rPyJQBmMb3B\r\nContent-Disposition: form-data; name="styleLabel"\r\n\r\nPhoto General 1\r\n------WebKitFormBoundaryhSt83rPyJQBmMb3B\r\nContent-Disposition: form-data; name="isPrivate"\r\n\r\nfalse\r\n------WebKitFormBoundaryhSt83rPyJQBmMb3B\r\nContent-Disposition: form-data; name="price"\r\n\r\n0\r\n------WebKitFormBoundaryhSt83rPyJQBmMb3B\r\nContent-Disposition: form-data; name="requestId"\r\n\r\n8-xFpNlTJS2G3H6Ox\r\n------WebKitFormBoundaryhSt83rPyJQBmMb3B\r\nContent-Disposition: form-data; name="resultUrl"\r\n\r\nhttps://hotpotmedia.s3.us-east-2.amazonaws.com/8-xFpNlTJS2G3H6Ox.png\r\n------WebKitFormBoundaryhSt83rPyJQBmMb3B--\r\n',
  //   method: "POST",
  //   mode: "cors",
  //   credentials: "include",
  // });
